...
class Resource(object):
    ...
    def clone(self, uri=None, res_id=None, metadata=None):
        """
        Clones this instance with the same data

        :param uri:
        :param res_id:
        :param metadata:
        :return: An instance with the same data filled
        """
        if uri is None:
            uri = self.uri
        ...
        return Resource(uri, res_id, metadata)
