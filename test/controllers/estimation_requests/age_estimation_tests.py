...
class AgeEstimationControllerTests(unittest.TestCase):
    """
    ...
    def setUpClass(cls):
        ...
        cls.age_estimation_controller = cls.factory.age_estimation_controller()

        cls.age_estimation_request_url = {
            "uri": "/estimation-requests/age/face/uri",
            "stream": "/estimation-requests/age/face/stream",
            "base64": "/estimation-requests/age/face/base64",
            "services": "/estimation-requests/age/services"
        }
    ...
    def get_services(self):
        """
        Retrieves the services for age estimation.
        :return: Services in JSON format
        """

        with self.app.test_client() as client:
            rv = client.get(self.age_estimation_request_url["services"])
    ...
    def send_request(self, content, type, extra_params):
        ...
        :param type: String setting the kind of request to make (one of the keys of age_estimation_request_url)
        :param extra_params: dictionary with parameters and values to append to the request.
        :return:
        """

        request_url = self.age_estimation_request_url[type]
    ...
    def test_detect_stream_service_parameter(self):
        ...
        response = self.send_request(jpeg_content, "stream", {
            "service": "caffe-cnn-levi-hassner-age-estimation"
        })
        ...
        self.assertIn("Age_range", response)
        self.assertIn("Age_range", response2)
        self.assertIn("Age_range", response3)
    ...
    def test_detect_stream(self):
        """
        API-Rest URL /estimation-requests/age/face/stream works for stream requests.
        """
    ...
    def test_detect_base64(self):
        """
        API-Rest URL /estimation-requests/age/face/base64 works for base64 requests.
        """
    ...
    def test_get_services(self):
        """
        Face detection services are visible in the API-Rest URL /estimation-requests/age/services
        :return:
        """
